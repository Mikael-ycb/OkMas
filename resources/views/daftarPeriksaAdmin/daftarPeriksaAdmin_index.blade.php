<x-layout4>
    ...
    <section class="px-6 md:px-20 pt-12 pb-8 bg-gradient-to-br from-slate-900 via-indigo-900 to-indigo-800">
        <h1 class="text-5xl font-white text-white mb-2 tracking-tight">📋 Manajemen Daftar Periksa</h1>
        <p class="text-indigo-100 text-lg">Kelola semua pemeriksaan pasien dan monitor status antrian</p>
    </section>

    <div class="px-6 md:px-20 pb-20 bg-gradient-to-b from-gray-50 to-white min-h-screen">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 border-t-4 border-indigo-500">
            ...
            <form id="filterForm" class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                ...
                <div>
                    ...
                    <select name="klaster" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-indigo-500 focus:outline-none font-semibold bg-white">
                ...
                {{-- Filter Button --}}
                <div>
                    <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl">
                        🔍 Terapkan Filter
                    </button>
                </div>
            </form>
        ...
        <div class="mb-8">
            @if($klaster == 'Umum')
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 shadow-lg">
                    <div class="flex justify-between items-center text-white">
                        <div>
                            <h2 class="text-3xl font-white">🩺 Klaster Umum</h2>
            ...
            @elseif($klaster == 'Gigi dan Mulut')
                <div class="bg-gradient-to-r from-pink-500 to-pink-600 rounded-2xl p-6 shadow-lg">
                    <div class="flex justify-between items-center text-white">
                        <div>
                            <h2 class="text-3xl font-white">🦷 Klaster Gigi & Mulut</h2>
            ...
            @elseif($klaster == 'Bidan')
                <div class="bg-gradient-to-r from-rose-500 to-rose-600 rounded-2xl p-6 shadow-lg">
                    <div class="flex justify-between items-center text-white">
                        <div>
                            <h2 class="text-3xl font-white">👶 Klaster Bidan</h2>
